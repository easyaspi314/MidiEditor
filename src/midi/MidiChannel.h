...
class MidiChannel : public ProtocolEntry {
    ...
    public:
         ...
         */
        NoteOnEvent* insertNote(ubyte note, int startTick, int endTick, ubyte velocity, MidiTrack *track);
         ...
         */
        static QColor colorByChannelNumber(ubyte number);
