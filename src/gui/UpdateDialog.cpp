...
UpdateDialog::UpdateDialog(Update *update, QWidget *parent):QDialog(parent) {
    ...
    QLabel *content = new QLabel(_("<html>"
                                     ...
                                     "<h3>Update</h3>"
                                     "<p>"
                                         "<b>New version: </b>%1 (Current version: %2)<br>"
                                         "<b>Changes: </b>%3"
                                     "</p>"
                                     "<h3>How to install the Update</h3>"
                                     "<p>Click <a href=\"%4\">here</a> to download the update. The link will open a browser window which contains a website which allows you to download the update. Close MidiEditor and execute the downloaded file to install the new version of MidiEditor.</p>"
                                     ...
                                     "</p>"
                                    "</body>"
                                 "</html>").arg(update->versionString(), QApplication::applicationVersion(), update->changelog(), update->path())
                                 );
    ...
    connect(close, &QPushButton::clicked, this, &UpdateDialog::hide);
}
